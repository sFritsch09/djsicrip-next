...
export default function FAQ() {
  ...
  const items = [
    ...
    },
    {
      ...
      answer:
        "Die Preise für einen Geburtstag oder anderen Veranstaltungen findest du hier:",
      linkText: "Preise",
      link: "/price",
    },
    {
    ...
    <div>
      ...
      <ImageWrapper variants={image} initial="initial" animate="animate">
        <Image
          ...
          src="https://pb.techchase.de/api/files/baa8qw390ee8nzl/v6h2kz4938vd5f9/profile_green_c_ohqk_enibr_mkHzFFETNR.jpg"
          alt="profile"
          fill
          placeholder="blur"
